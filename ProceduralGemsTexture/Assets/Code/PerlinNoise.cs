...
//***************************************
//Changed to allow modification of hashMask
//so we can control tiling period
//***************************************
...
public sealed class PerlinNoise
{
    ...
    public PerlinNoise(int tilePeriod = 256)
    {
        hashMask = tilePeriod - 1;
    }
    ...
    public PerlinNoiseSample Perlin1D(Vector3 point, float frequency)
    {
        point *= frequency;
    ...
    public PerlinNoiseSample Perlin2D(Vector3 point, float frequency)
    {
        point *= frequency;
    ...
    public PerlinNoiseSample Perlin3D(Vector3 point, float frequency)
    {
        point *= frequency;
        int ix0 = Mathf.FloorToInt(point.x);
        int iy0 = Mathf.FloorToInt(point.y);
